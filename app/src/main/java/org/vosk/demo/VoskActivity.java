...
public class VoskActivity extends Activity implements
    ...
    private List<String> check() {
        ...
        Lcs lcs = new Lcs(sentence, stringBuilder.toString());

        sentence_splited = lcs.getSentence_splited();
    ...
    private void show(){
        ...
        checkTrue checkTrue = new checkTrue(sentence_splited,check);
        List<Boolean> res = checkTrue.getResult();
            ...
            if(!res.get(i)){
                try {
                    msp.setSpan(new ForegroundColorSpan(Color.RED),
                            sentence.indexOf(sentence_splited.get(i)),
                            sentence.indexOf(sentence_splited.get(i)) +sentence_splited.get(i).length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                } catch (Exception e) {
